...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Desarrollo de un prototipo funcional de máquina lanzapelotas para entrenamiento técnico en tenis} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Esp. Ing. Lucas Fabricio Monzón Languasco} \\[1cm]
        ...
        \textbf{Director:} Dr. Ing. Gustavo Zavala (UMA)} \\[1cm]
        ...
        Ciudad de Corrientes, agosto de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
